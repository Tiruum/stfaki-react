            ...
            <footer className="border-top box-shadow" style={{backgroundColor: '#eff5f9'}}>
                <div className="container d-flex flex-wrap justify-content-between align-items-center py-3">
                    ...
                    <ul className="nav col-md-6 justify-content-end list-unstyled d-flex">
                        <li className="ms-3"><a class="text-muted fs-3" href="https://www.instagram.com/astech_mipt/"><i className="fa-brands fa-instagram"></i></a></li>
                        <li className="ms-3"><a class="text-muted fs-3" href="https://vk.com/astech_mipt"><i className="fa-brands fa-vk"></i></a></li>
                    </ul>
                </div>
            </footer>
        )
