...
export default class LoginForm extends Component {
    ...
    render() {
        ...
        <div className="container-fluid">
            <div className="row position-absolute w-100 h-100" id="rowWrapper">
                <div id="logoWrapper" className="col-lg-6 col-md-4 col-sm-0 d-lg-block d-md-block d-sm-none d-none">
                    <Logo />
                </div>
                <div className="col-lg-6 col-md-8 col-sm-12 d-flex justify-content-center">
                    <div className="p-5 d-block card my-auto" id='form-card'>
                        <LoginHeader />
                        <form action="/" className="d-flex flex-column mx-auto">
                            ...
                            <div className="d-flex justify-content-center flex-wrap align-content-center p-0 mb-2">
                                ...
                                <div className="form-group p-0 order-2">
                                    <a href="https://google.com" className="link text-left fw-bolder text-sm">Забыл пароль</a>
                                </div>
                            </div>
                        ...
                        <div className="mt-3 container-fluid">
                            <p className="text-center text-sm">Нет учетной записи? <a href="https://google.com" className="form">Зарегистрируйтесь!</a></p>
                        </div>
                    </div>
                </div>
            </div>
