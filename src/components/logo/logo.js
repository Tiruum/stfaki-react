...
class Logo extends Component {
    render() { 
        return (
            <svg id="logo" style={logo} className = "position-absolute w-50 top-50 start-0 translate-middle-y" data-name="logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 41 49">
