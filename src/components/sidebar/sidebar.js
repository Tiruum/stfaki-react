    ...
    if (username) {
        ...
        return (
            <div className="border-bottom">
                <Link to={`/login`} className="d-flex ps-3 pt-3 fs-5" type="button" id="profileDropdown">
...
export default class Sidebar extends Component {
    ...
    render() {
        const { username, email, profilePic } = this.props.data;
        ...
        <div>
            ...
            <nav id="sidebar">
                ...
                <div className="border-top position-absolute bottom-0 container-fluid p-2">
